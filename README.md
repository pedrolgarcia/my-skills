...
Para ajudar você a não se esquecer das suas habilidades e competências. O app <b>my.skills</b> é um pontapé inicial para o curso, abordando vários conceitos e fundamentos do React Native e do mundo mobile.

### ✅ Features
- [x] Cadastro de transação (entrada/saída) com categorias pré-definidas para maior organização
- [x] Saudações baseada no horário do dia
